...
class AISetup:
    ...
    discountFactor = 0.99
    learningStepsPerEpochs = 500
    #learningStepsPerEpochs = 2000
    epochs = 20
    replayMemorySize = 1000
    batchSize = 64
    testEpisodesPerEpoch = 1
    frameRepeat = 12
    #resolution = (30,45)
    resolution = (200,640)
    #episodesToWatch = 10
    ...
    def initialize_vizdoom(self):
        ...
        #game.add_game_args("-join 127.0.0.1:10667")
...
myAIAgent = AISetup()
myAIAgent.setDefaultModelFolder('/home/devcom/Downloads/files/doomsters2019-master/model')
#myAIAgent.setDefaultModelFolder('/home/juliux/Documents/repository/doom2019/model')
myAIAgent.setDefaultConfiguration('/home/devcom/Downloads/files/doomsters2019-master/etc/main_configuration.cfg')
